...
2. [Install Finnish Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Finnish language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Finnish language pack {#active}

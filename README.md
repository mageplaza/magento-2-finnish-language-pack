...
![Finnish language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-finnish-language-pack:dev-master mageplaza/module-smtp 
